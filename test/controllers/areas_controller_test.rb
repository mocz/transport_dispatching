...
class AreasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create area" do
    assert_difference('Area.count') do
      post areas_url, params: { area: { barangay: @area.barangay, fuel: @area.fuel, km_distance: @area.km_distance, town: @area.town, zone: @area.zone } }
    end
  ...
  test "should update area" do
    patch area_url(@area), params: { area: { barangay: @area.barangay, fuel: @area.fuel, km_distance: @area.km_distance, town: @area.town, zone: @area.zone } }
