...
class DispatchesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create dispatch" do
    assert_difference('Dispatch.count') do
      post dispatches_url, params: { dispatch: { description: @dispatch.description, driver_id: @dispatch.driver_id, plantation_id: @dispatch.plantation_id, status: @dispatch.status, time_arrived: @dispatch.time_arrived } }
    end
  ...
  test "should update dispatch" do
    patch dispatch_url(@dispatch), params: { dispatch: { description: @dispatch.description, driver_id: @dispatch.driver_id, plantation_id: @dispatch.plantation_id, status: @dispatch.status, time_arrived: @dispatch.time_arrived } }
