...
class DriversTest < ApplicationSystemTestCase
  ...
  test "creating a Driver" do
    ...
    fill_in "Affiliation", with: @driver.affiliation
    fill_in "Contact no", with: @driver.contact_no
    fill_in "Date employed", with: @driver.date_employed
    fill_in "Name", with: @driver.name
    fill_in "Truck", with: @driver.truck_id
