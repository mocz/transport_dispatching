...
class AreasTest < ApplicationSystemTestCase
  ...
  test "creating a Area" do
    ...
    fill_in "Barangay", with: @area.barangay
    fill_in "Fuel", with: @area.fuel
    fill_in "Km distance", with: @area.km_distance
    fill_in "Town", with: @area.town
    fill_in "Zone", with: @area.zone
